...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center vh-100 mt-5">
        <div class="container text-center">
            <a href="./sair.php" class="btn btn-primary">Logout</a>
            <span id="msg"></span>
            <div id='calendar'></div>
        </div>
    </div>
                ...
                <div class="modal-body">
                    ...
                    <div id="editarEvento" style="display: none;">
                        ...
                        <form method="POST" id="formEditEvento">
                            ...
                            <div class="row mb-3">
                                <label for="edit_descricao" class="col-sm-2 col-form-label">Descrição</label>
                                <div class="col-sm-10">
                                    <input type="text" name="edit_descricao" class="form-control" id="edit_descricao" placeholder="Descrição">
                                </div>
                            </div>
                            <div class="row mb-3">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" id="formCadEvento">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="cad_descricao" class="form-control" id="cad_descricao" placeholder="Descrição">
                            </div>
                        </div>
                        <div class="row mb-3">
